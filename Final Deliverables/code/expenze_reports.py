...
def generateMonthlyReport(userID, year=None):
    ...
    spending_month_chart = expenze_dashboard.getMonthlySpending(userID, year)
...
def generateSpendingTrendsReport(userID, year=None):
    ...
    spending_trends_chart = expenze_dashboard.getSpendingTrends(userID, year)
    ...
    categories_inactive = expenze_categories.getSpendCategories_Inactive(userID)

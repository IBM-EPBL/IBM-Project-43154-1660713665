// SUMMARY: this file handles all of the functionality on the 'Create Budget' and 'Update Budget' pages of expenze Tracker.
...
function calculateEstimates() {
    ...
    document.getElementById("weekly").innerHTML = "Weekly amount: " + new Intl.NumberFormat('en-IN', { style: 'currency', currency: 'INR' }).format(weekly);
    document.getElementById("monthly").innerHTML = "Monthly amount: " + new Intl.NumberFormat('en-IN', { style: 'currency', currency: 'INR' }).format(monthly);
...
function calculateCategories(percentInput) {
    ...
    if (percentInput.value > 0 && percentInput.value <= 100) {
        ...
        categoryLabel.innerHTML = "Total amount: " + new Intl.NumberFormat('en-IN', { style: 'currency', currency: 'INR' }).format(categoryBudget * (percentInput.value / 100)) + "<br>Weekly amount: " + new Intl.NumberFormat('en-IN', { style: 'currency', currency: 'INR' }).format(categoryWeekly * (percentInput.value / 100)) + "<br>Monthly amount: " + new Intl.NumberFormat('en-IN', { style: 'currency', currency: 'INR' }).format(categoryMonthly * (percentInput.value / 100));
